...
bool RectangularCollisionStrategy::execute(
  ...
  float left1 = obj1.X()+50;
  float left2 = obj2.X()+46;
  float right1 = left1+obj1.getFrame()->getWidth()+50;
  float right2 = left2+obj2.getFrame()->getWidth()+46;
  if ( right1 < left2 ) return false;
  if ( left1 > right2 ) return false;
  float top1 = obj1.Y()+50;
  float top2 = obj2.Y()+46;
  float bottom1 = top1+obj1.getFrame()->getHeight()+50;
  float bottom2 = top2+obj2.getFrame()->getHeight()+46;
...
bool PerPixelCollisionStrategy::execute(
  ...
  Vector2f p1 = obj1.getPosition() - Viewport::getInstance().getPosition()-Vector2f(50,46);
  Vector2f p2 = obj2.getPosition() - Viewport::getInstance().getPosition()-Vector2f(50,46);
