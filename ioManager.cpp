...
void IOManager::makeFrame(int* frameCount,const std::string& username) {
...
void IOManager::printMessageAtF(const string& msg, Sint16 x, Sint16 y, TTF_Font *font ) const {
   Uint16 zero = 0;
   SDL_Rect dest = {x,y,zero,zero};
   SDL_Surface * stext = TTF_RenderText_Blended(font, msg.c_str(), color);
   if (stext) {
